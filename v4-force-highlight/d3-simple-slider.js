...
typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-transition'), require('d3-axis'), require('d3-selection'), require('d3-array'), require('d3-scale'), require('d3-dispatch'), require('d3-drag'), require('d3-ease')) :
typeof define === 'function' && define.amd ? define(['exports', 'd3-transition', 'd3-axis', 'd3-selection', 'd3-array', 'd3-scale', 'd3-dispatch', 'd3-drag', 'd3-ease'], factory) :
(global = global || self, factory(global.d3 = global.d3 || {}, global.d3, global.d3, global.d3, global.d3, global.d3, global.d3, global.d3, global.d3));
}(this, (function (exports, d3Transition, d3Axis, d3Selection, d3Array, d3Scale, d3Dispatch, d3Drag, d3Ease) { 'use strict';
